...
const portfolioData = {
  'project-manager': {
    ...
    subtitle: 'Harisenin Bootcamp & Joki Proyek',
    description: 'Developing skills in Product Lifecycle Management (PLM), drafting detailed Product Requirement Documents (PRDs), and aligning cross-functional design, tech, and marketing teams for digital products. Additionally experienced as Key Account IT at Joki Proyek managing software delivery.',
    src: '/img/project-manager.png',
    tools: ['PRD Writing', 'Figma', 'Jira', 'Notion', 'Trello', 'Agile Roadmapping'],
    projects: [
      {
        id: 'mediaease-prd',
      ...
      },
      {
        ...
        tools: ['Auditing System', 'Quality Indicators (SN-Dikti)', 'Process Mapping', 'Notion', 'Google Workspace'],
        role: 'Internal Auditor & Lead PM',
        timeline: 'Dec 2025 - Apr 2026',
        status: 'Real Case System Implementation',
        deliverables: ['SPMI Auditing Standard Document', 'Process Audit Flowcharts', 'Notion Audit Indicators Dashboard', 'Correction Action Plans (RTL)'],
        achievements: [
  ...
  'uiux': {
    ...
    subtitle: 'MySkill, Dibimbing & Socmed Buddies',
    description: 'Certified UI/UX designer with intensive training from MySkill, Dibimbing.id, and real graphic layouts experience at Socmed Buddies. Skilled in user-centered design methodologies, conducting user research, wireframing, high-fidelity layouts, and interactive prototyping.',
    src: '/img/uiux.png',
    ...
    projects: [
      {
        ...
        description: 'Sound of IWU is a landing page design for IWU\'s music community and recording hub. Crafted to capture a vibrant musical identity, highlighting studio portfolios, booking services, and artist lists with a premium glassmorphic dark mode theme.',
        ...
        achievements: [
          'Created custom grid templates matching dark-mode musical aesthetics with interactive studio hover effects.',
          'Designed a complete music service packaging page, artist showcase, and contact flows.',
          'Built a high-fidelity interactive prototype with smooth screen transitions and video popups.'
        ],
      ...
      },
      {
        ...
        achievements: [
          'Created comprehensive low-fidelity and high-fidelity wireframes detailing the home page and online order systems.',
          'Designed an elegant custom color scheme combining brand identity with modernized layouts.',
          'Improved visual hierarchy and navigation to increase customer reservation conversions by up to 30%.'
        ],
  ...
  'frontend-dev': {
    ...
    description: 'Software engineering background from SMKN 13 Bandung, BNSP Certified Junior Web Developer, and informatics S1 studies. Focuses on translating UI/UX layouts into clean, responsive web code using React.js and Tailwind CSS, and shared knowledge as a seminar speaker.',
    src: '/img/fe.png',
    tools: ['React.js', 'Vue.js', 'Vuetify', 'JavaScript', 'Tailwind CSS', 'Git & GitHub'],
    projects: [
      {
        id: 'bws-admin',
        ...
        src: '/img/fe-dev/bws-admin.png',
        images: ['/img/fe-dev/bws-admin.png', '/img/fe-dev/bws-login.png'],
        tools: ['Vue.js', 'Vuetify', 'JavaScript', 'REST API Integration', 'Vuex', 'Vue Router'],
        achievements: [
          'Designed secure login flows and role-based interface access control panels.',
          'Integrated rest APIs with proper loading feedback, data tables pagination, and lookup filters.',
          'Optimized frontend layout grids resulting in faster operation and navigation across massive financial records.'
        ]
      },
      {
        ...
        src: '/img/fe-dev/sayaginet-cover.png',
        images: ['/img/fe-dev/sayaginet-cover.png', '/img/fe-dev/sayaginet-dashboard.png'],
        tools: ['Vue.js', 'Vuetify', 'Chart.js', 'REST API Integration', 'JavaScript', 'SCSS'],
        achievements: [
          'Created responsive analytics layout charts using Chart.js to monitor bandwidth levels.',
          'Built modular client transaction list grids with secure REST backend calls.',
          'Implemented automated billing panels and operational status tracking workflows.'
        ]
      },
      {
        id: 'grad-absen',
        ...
        description: 'A specialized attendance registration system built for the graduation ceremony of SMKN 13 Bandung. Features a mobile-first QR code scanning interface for students and an elegant web dashboard displaying live attendance analytics.',
        ...
        achievements: [
          'Engineered a fast, mobile-friendly interface equipped with a scanner component for rapid queues.',
          'Created a real-time analytics dashboard with status updates, seat counters, and check-in logs.',
          'Successfully processed real-time event arrival check-ins for the graduation ceremony.'
        ]
      }
    ]
  }
          ...
          {data.projects.map((project) => {
            ...
            return (
              <div
                ...
                className={`group p-5 bg-card border rounded-xl cursor-pointer transition-all duration-300 transform hover:-translate-y-1 text-start ${
                  isActive 
