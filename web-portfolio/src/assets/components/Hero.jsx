      ...
      <div className='hero grow content-end'>
        ...
        <div className='hero-text w-full absolute'>
          ...
          <button
            ...
            className="mt-12 mx-auto w-12 h-12 flex items-center justify-center rounded-full border border-aksen/40 bg-text/70 text-card hover:bg-card hover:border-aksen transition-all duration-300 animate-bounce group shadow-lg hover:shadow-aksen/25"
